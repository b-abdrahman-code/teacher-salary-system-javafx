...
public class AddCongeDeMaterniteApp extends Application {

    public AddCongeDeMaterniteApp() {
        // Public constructor
    }
    @Override
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("add_conge_de_maternite.fxml"));
